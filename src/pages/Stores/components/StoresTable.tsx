...
const COLUMNS = 'grid-cols-[1.4fr_1fr_1fr_1fr_0.8fr_1fr]';
...
export function StoresTable({
  ...
  return (
    <section className="border border-atlas-ink/14">
      ...
      <DataState loading={loading} error={error} empty={stores.length === 0} emptyLabel="No stores found.">
        {stores.map((store) => (
          <div
            key={store.id}
          ...
          >
            ...
            <span className="truncate">{store.client_id}</span>
